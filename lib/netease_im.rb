...
module NeteaseIM
  class Client
    ...
    def send_group_msg(from: , group_id: , body: {}, extra: {}, options: {})
      post( ACTION_SEND_MSG, { from: from, to: group_id, body: body.to_json, ope: 1, ext: extra }.merge(options) )
    end

    def send_batch_msg(from: , to: , body: {}, extra: {}, type: 0, options: {})
      post( ACTION_SEND_BATCH_MSG, { fromAccid: from, toAccids: to.to_json, body: body.to_json, type: type, ext: extra }.merge(options) )
    end

    def send_batch_custom_msg(from: , to: , msg: , extra: {}, options: {})
      post( ACTION_SEND_BATCH_MSG, { fromAccid: from, toAccids: to.to_json, body: { msg: msg }.to_json, type: 100, ext: extra }.merge(options) )
    end
